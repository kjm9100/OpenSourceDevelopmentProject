...
public class ChattingActivity extends AppCompatActivity {
    ...
    private DatabaseReference myRef_notify = database.getReference().child("ChatRoom_Member");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SERVER_KEY = myRef.child("key").getKey().toString();
        Log.d("SERVER_KEY: ", SERVER_KEY);
...
//                    myRef_notify.child(CurrentSubject).child("Student").addValueEventListener(new ValueEventListener() {
//                        @Override
//                        public void onDataChange(@NonNull DataSnapshot snapshot) {
//                            TokenData tData = snapshot.getValue(TokenData.class);
...
//                }
    ...
    public void addChatDate(String name, String message , String number){
        ...
        sendPostToFCM_usr(CurrentSubject,"What do you think?","fNw7DilXQhiFGP5xG32YiE:APA91bH8KUnHQXnscZXSb4jAipQ4u32RlzXB2SZpexgaFEhyB84I_AjC3T_7fLLnzwqH-r0NuEOXWk6mom_3x_rQvSXOmDBzv5qhiRYVcXCJCEJJXKstvHXC1BTrNLumJffqu_t8-qMP");
        Log.e("Success______", CurrentSubject);
    }
