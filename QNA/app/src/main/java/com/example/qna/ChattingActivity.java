        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(msg != null){
                    ...
                    /*myRef.child("ChatRoom_Member").child(CurrentSubject).child("Student").addValueEventListener(new ValueEventListener() {
                        @Override
                    ...
                    sendPostToFCM_usr(CurrentSubject,"TEST__", token);*/
                }
            }
        });
