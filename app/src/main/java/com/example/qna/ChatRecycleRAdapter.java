...
public class ChatRecycleRAdapter extends RecyclerView.Adapter<ChatRecycleRAdapter.MyViewHolder> {
    ...
    private DatabaseReference myRef_prof = database.getReference().child("ChatRoom_Member");
        ...
        holder.check_box.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (chat.getCheck_cnt() >= 1) {
                    myRef_prof.child(Subject).child("Pro").addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ProKey = snapshot.getValue().toString();
                            sendPostToFCM_usr(Subject, "In " + Subject + " need your help, professor!", ProKey);
//                            Log.e("ProKey________________", ProKey);
//                            Log.e("CHECK_________Post", ProKey);
                        }
        ...
        private void sendPostToFCM_usr ( final String title, final String body,
